...
class Arper():
    ...
    def __init__(self, victim, target, gateway, interface="eth0"):
        self.victim = victim
        self.victimMac = get_mac(victim)
        self.target = target
        self.targetMac = get_mac(target)
        ...
        print('Target ({}) is at {}.'.format(target, self.targetMac))
        print('-'*30)
...
if __name__ == '__main__':
    ...
    gateway = "10.0.3.2"
    interface = "enp0s3"
    myarp = Arper(victim, target, gateway, interface)
