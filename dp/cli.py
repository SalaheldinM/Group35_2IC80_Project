...
def attackPrompt():
    ...
    if attackNumber == 1: # ARP Poisoning Attack
        ...
        victimTwoIP = input('Please provide the IP address of the second victim: ')
        ...
        # Initialize missing variables
        gatewayIP = input('Please provide the IP address of the gateway: ')
        dnsList =input('Please provide the dns names: ').split()
        dnsIPList = input('Please provide the IP Addresses to spoof DNS names to: ').split()
